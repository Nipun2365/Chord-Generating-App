...
class PionosongDetailsPage extends StatefulWidget {
  final String title;
  final String artist;
  final String url;

  const PionosongDetailsPage({
    Key? key,
    required this.title,
  ...
  @override
  State<PionosongDetailsPage> createState() => _PionosongDetailsPageState();
}

class _PionosongDetailsPageState extends State<PionosongDetailsPage> {
