...
class GuitarsongDetailPage extends StatefulWidget {
  final String title;
  final String artist;
  final String url;

  const GuitarsongDetailPage({
    Key? key,
    required this.title,
  ...
  @override
  State<GuitarsongDetailPage> createState() => _GuitarsongDetailPageState();
}

class _GuitarsongDetailPageState extends State<GuitarsongDetailPage> {
