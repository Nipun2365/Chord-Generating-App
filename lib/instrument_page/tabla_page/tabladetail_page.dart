...
class TabladetailPage extends StatefulWidget {
  final String title;
  final String artist;
  final String url;

  const TabladetailPage({
    Key? key,
    required this.title,
  ...
  @override
  State<TabladetailPage> createState() => _TabladetailPageState();
}

class _TabladetailPageState extends State<TabladetailPage> {
