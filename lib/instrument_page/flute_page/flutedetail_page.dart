...
class FlutedetailPage extends StatefulWidget {
  final String title;
  final String artist;
  final String url;

  const FlutedetailPage({
    Key? key,
    required this.title,
  ...
  @override
  State<FlutedetailPage> createState() => _FlutedetailPageState();
}

class _FlutedetailPageState extends State<FlutedetailPage> {
