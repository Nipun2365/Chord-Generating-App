...
class KeyboardsongDetail extends StatefulWidget {
  final String title;
  final String artist;
  final String url;

  const KeyboardsongDetail({
    Key? key,
    required this.title,
  ...
  @override
  State<KeyboardsongDetail> createState() => _KeyboardsongDetailState();
}

class _KeyboardsongDetailState extends State<KeyboardsongDetail> {
